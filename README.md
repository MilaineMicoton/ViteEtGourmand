...
Cependant si vous essayez de passer commande, vous attérirez sur la page connexion.
...
Une fois l'inscrition acceptée, il faut aller se connecter.
...
Choisir un menu et cliquer sur lebouton Commander. Cela vous mènera vers la page
...
commande apparaîtra. De là, vous pourrez recommander, ou (quand cette page est 
codée) visionner vos commandes.
